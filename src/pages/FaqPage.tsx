...
const faqs = [
  {
    q: "누끼따는 정말 무료인가요?",
    a: "네, 누끼따는 하루 50장까지 완전 무료로 이용할 수 있습니다. 회원가입도 필요 없습니다. 무료 한도는 매일 자정(KST)에 초기화됩니다. 일반적인 쇼핑몰 셀러, 디자이너, 학생 등 대부분의 사용자에게 충분한 양입니다.",
  },
  {
    q: "이미지가 서버로 전송되나요?",
  ...
  {
    q: "처리 속도는 얼마나 걸리나요?",
    a: "처리 속도는 사용자의 기기 사양에 따라 달라집니다. WebGPU를 지원하는 브라우저(Chrome, Edge 최신 버전)에서는 GPU 가속을 통해 이미지당 약 1~3초 내에 처리됩니다. WebGPU가 지원되지 않는 경우 WASM으로 자동 전환되며, 이 경우 5~15초 정도 소요될 수 있습니다. 첫 방문 시 AI 모델 다운로드(약 45MB)에 추가 시간이 필요하지만 이후에는 캐시를 사용합니다.",
  },
  {
